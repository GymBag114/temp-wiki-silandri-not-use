...
:::tip 阅读顺序
建议先看完本页，再继续阅读 [入门正文](./basics.md)；高危站点和复杂路线统一放在 [进阶实践](./advanced-practice.md)，配装表和查表附录统一放在 [补充内容](./supplemental-content.md)。如果你想把完整的新手代理人教学也跑一遍，可以并行参考 [寻找代理人](./finding-agents.md)、[工业与商业代理人](./industry.md) 和 [军事代理人](./military.md)。
:::
...
![0-1-first-exploration-32](./images/getting-started/first-exploration-32.webp) 

看着这么多红色的球是不是眼晕，有个很简单的办法能让你盯住一个信号扫描

![0-1-first-exploration-33](./images/getting-started/first-exploration-33.webp) 
...
![0-1-first-exploration-44](./images/getting-started/first-exploration-44.webp) 

这里需要注意，探针只能在太空里停留1个小时！，时间到了会消失！

过星门和进空间站等探针会自动收回！

![0-1-first-exploration-45](./images/getting-started/first-exploration-45.webp) 

数据地点的提示，对于做完商业任务的你来说没有难度

![0-1-first-exploration-46](./images/getting-started/first-exploration-46.webp) 

破译完，捡东西走人

第四步任务

![0-1-first-exploration-47](./images/getting-started/first-exploration-47.webp) 

与第三步步骤基本相同，记得带遗迹分析仪

![0-1-first-exploration-48](./images/getting-started/first-exploration-48.webp) 

代理人提示

![0-1-first-exploration-49](./images/getting-started/first-exploration-49.webp) 任务完成。

第5步

![0-1-first-exploration-50](./images/getting-started/first-exploration-50.webp) 

需要你去扫出气云地点然后进去拿道具，接受任务后你的物品机库里会出现一个气云通行证，带着它你才能进第二层轨道

![0-1-first-exploration-51](./images/getting-started/first-exploration-51.webp) 
...
- Ghost Site 的计时逻辑、可见倒计时与撤离判断，请以 [进阶实践页的「幽灵坟」部分](./advanced-practice.md#幽灵坟-ghost-sites) 为准。
...
这里是快速指南，涉及内容需要通读全文后才能理解。常用网站、产出与配装表统一整理在 [补充内容](./supplemental-content.md)。
