...
![0-1-first-exploration-26](./images/explore/getting-started/first-exploration-26.webp) 是精确发射，点击一下

![0-1-first-exploration-28](./images/explore/getting-started/first-exploration-28.webp) 是分散发射，点击一下，

注意观察他们的不同

![0-1-first-exploration-30](./images/explore/getting-started/first-exploration-30.webp) 是收回你在太空中的探针
...
![1.00](./images/explore/getting-started/first-exploration-32.webp)

看着这么多红色的球是不是眼晕，有个很简单的办法能让你盯住一个信号扫描

![1.00](./images/explore/getting-started/first-exploration-33.webp)
...
需要注意的一点是，探针只能在太空里停留1个小时，时间到了会消失

过星门和进空间站等探针会自动收回

数据地点的提示，对于做完商业任务的你来说没有难度，破译完捡东西走人即可

第四步任务

维托尔.福根:又是我(

与第三步的步骤基本相同，记得带遗迹分析仪

第5步
需要你去扫出气云地点然后进去拿道具，接受任务后你的物品机库里会出现一个气云通行证，带着它你才能进第二层轨道，然后依旧是干完活拿东西走人
...
* 幽灵坟 的计时逻辑、可见倒计时与撤离判断，请以 [进阶实践页的「幽灵坟」部分](./advanced-practice.md#幽灵坟-ghost-sites) 为准。
...
2. 阿斯特罗(小白)：适合作为新人到熟手的过渡船，但默认应该建立在你已经能稳定使用隐形、知道何时该贪何时该跑的前提上。
3. 隐秘行动 隐侦：如果你的目标是“纯探索效率”，它通常比 阿斯特罗 更专业、更便宜，也更符合只挖不打的思路。
4. 斯特修斯 或者 T3C：更像复合用途平台，适合幽灵坟、冬眠者储藏站、战斗气云或兼顾自保/反打，不是普通新人挖坟的第一跳升级。
...
1. 如果你的路线依赖隐形与隐跳，请按 Omega + Cloaking 技能路线规划；Alpha 也能做基础扫描和低成本探索，但生存与效率会明显下降。地狱模式开局的新人如果暂时不上隐形，至少要学会做深空点，4AU 内扫到作战针就跳走
2. 如果是挖坟 0 技能用户，条件允许的话，推荐吃 1 罐脑浆，把扫描技能下 7 项都点到 3 级，把种族护卫也点到 3 级
3. 买一条种族考古船（推荐苍鹭）,按照后面的推荐配装思路配好，目前你应该有75+的扫描强度，大部分的坟都能顺利扫出，接下来就可以开始你的探险活动啦

### 后期

1. 根据后文钢板小白配装所需的装备点上相应的技能，隐身相关技能 点到 4 级，为了上隐秘行动 `隐秘行动装置2`。扫描技能下把 `天体测量学` 点到 4 级，然后点 `黑客攻击` 到满级，上 T2 数据分析仪，最后 `考古学` 点到满级，上 T2 遗迹分析仪（一共大概 4 罐脑浆）
2. 开上小白 Astero。如果还不能使用隐秘行动，非常不建议直接上小白。前期请先拿苍鹭试水高级坟，有了 T2 分析仪后，成功率会大大增加
3. 点 控制论 到 5 上黑镜脑插，补上各种基础工程学技能（重要），后续扫描技能把 天体测量学 点满
4. 至此你的挖坟技能已经成型，后续可以考虑 T2 隐侦、斯特修斯(中白)或者金鹏，然后开发自己的挖坟套路
