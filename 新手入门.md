...
:::tip 阅读顺序
建议先看完本页，再继续阅读 [入门正文](./入门正文.md)；高危站点、配装表和查表附录统一放在 [进阶与附录](./进阶与附录.md)。
:::
...
- Ghost Site 的计时逻辑、可见倒计时与撤离判断，请以 [进阶与附录页的「幽灵坟」部分](./进阶与附录.md#幽灵坟-ghost-sites) 为准。
...
这里是快速指南，涉及内容需要通读全文后才能理解。常用网站、产出与配装表统一整理在 [进阶与附录](./进阶与附录.md)。
